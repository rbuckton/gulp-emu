'use strict';
let multipageMap = JSON.parse(`{"index":["sec-intro"],"example":["sec-example","_ref_0","_ref_1","_ref_2","_ref_3"],"copyright-and-software-license":["sec-copyright-and-software-license"]}`);
'use strict';
